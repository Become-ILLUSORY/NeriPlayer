...
object SettingsKeys {
    ...
    val YOUTUBE_REVERSE_PROXY_ENABLED =
        booleanPreferencesKey("youtube_reverse_proxy_enabled")
    val YOUTUBE_REVERSE_PROXY_BASE_URL =
        stringPreferencesKey("youtube_reverse_proxy_base_url")
